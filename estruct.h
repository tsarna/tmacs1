...
#define	MDPYMOD	0x0004			/* Python indentation and fence */
#define	MDSPELL	0x0008			/* spell error parcing		*/
...
#define	MDCRYPT	0x0100			/* encrytion mode active	*/
#define	MDASAVE	0x0200			/* auto-save mode		*/
#define	MDSTX	0x0400			/* StructedText mode		*/
